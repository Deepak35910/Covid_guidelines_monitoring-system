...
def color_cloth(img_pass):
    ...
    #img=cv2.imread(r'C:\Users\Deepak\Social_distancing_tracking_color\data\video\black.JPG')
    window_name = 'image'
    ...
    json_file = open('color_weights.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)
    # load weights into new model
    loaded_model.load_weights("color_weights.h5")
